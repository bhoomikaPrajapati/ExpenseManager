...
/**
 * Created by  bhoomika on 10/2/17.
 */
...
public class PassCodeView extends View {
    ...
    private void preparePaint() {
        ...
        textPaint.setColor(Color.rgb(253,187,17));
        textPaint.density = getResources().getDisplayMetrics().density;
        textPaint.setTextSize(keyTextSize);

     //   Typeface typeFace = Typeface.createFromAsset(context, "fonts/Chunkfive.otf");
      //  textPaint.setTypeface(Typeface.createFromAsset(context.getAssets(),"fonts/Font-Bold.ttf"));
